    ...
    render() {
        ...
        if(userRole === 'applicant') {
            ...
            <div>
                ...
                <ul>
                    <li>Experience:
                        <Tooltip title="Add Experience" aria-label="added">
                        ...
                        <ul>
                            {user.education.map(ed => (
                                <li>
                                    <ul>
                                        <li>Recruiter: {ed.school}</li>{/*school is recruiter*/}
                                        <li>Work: {ed.degree}</li>{/*degree is work*/}
                                    ...
                                    <div>
                                        { !this.state.showform || ed._id !== this.state.editing? 
                                            <div>
                                                <Tooltip title="Delete Above Experience" aria-label="delete">
                                                <button
                                                style={{
                                                    color: "#FF0000",
                                                    }}
                                                ...
                                                <Tooltip title="Edit Above Experience" aria-label="edit">
                                                <button
                                                    style={{
                                                    color: "#0000FF",
                                                    }}
        ...
        return (
            <div style={{ height: "75vh" }} className="container valign-wrapper">
                <div className="row">
                    ...
                    <Card style={{width: '50%', marginLeft: "25%", borderRadius: "15px", height: '500px', backgroundImage: `url("https://i.pinimg.com/originals/fb/8e/1b/fb8e1bf27c31e4750cff5adf0c3cf0e3.jpg")`,  backgroundRepeat: "no-repeat", backgroundSize: "100% 100%" }}>
                        <Card.Header>
                            <h4>My Profile</h4>
                        </Card.Header>
                        <Card.Body>
