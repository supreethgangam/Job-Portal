...
class JobsList extends Component {
    ...
    onSOPsubmit(job)
    {
        ...
        let num = this.state.enteredsop.length;

        let soperror = "";
        if(num!=10)
        {
            soperror = "Phone Number Invalid";
            this.setState({sopError: soperror});
        }

        if(num == 10 && this.state.userdetails.numapp <= 10)
        {
            axios
            ...
            alert("Phone number cannot have more than 10 numbers");
        }
    }
                                            ...
                                            <TableCell>
                                                <div>
                                                    <div className="input-field">
                                                        <label htmlFor="enteredsop">Enter Contact Number:</label><br></br>
                                                        <input
                                                            onChange={this.onChange}
