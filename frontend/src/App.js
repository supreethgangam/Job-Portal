...
function App() {
  return (
    <Provider store={store}>
      <Router>
        <div style={{backgroundImage: `url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9VhUuF6Z6RxrrhzyWZ7Fv1ASv2hCbZYOiGQ&usqp=CAU")`, backgroundRepeat: "no-repeat", backgroundSize: "100% 100%", height:"800px" }}>
          <br/>
